import { UpdateBusinessProfileRequestSchema } from "@application/dtos/business/UpdateProfile";
...
businessRouter.patch(ROUTES.PASSWORD,userAuthMiddleware,validateRequest(ResetUserPasswordRequestSchema),(req:Request,res:Response,next:NextFunction)=>businessController.updatePassword(req,res,next));
