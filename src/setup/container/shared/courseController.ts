...
import { enrollmentRepository, learnerProgressRepository, quizRepository } from "./dependencies";
...
const getCourseDetailsUseCase= new GetCourseDetailsUseCase(courseRepository,s3Service,quizRepository)
